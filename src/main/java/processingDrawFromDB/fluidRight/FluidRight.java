package processingDrawFromDB.fluidRight;
...
public class FluidRight extends PApplet {
    ...
    public static void main (String[] args) {
        PApplet.main("processingDrawFromDB.fluidRight.FluidRight");
    }
    ...
    class FluidCircle {
        ...
        FluidCircle(float radius) {
            ...
            direction = random(1) > 0.5 ? 1.0f : -1.0f;
        }
    }
